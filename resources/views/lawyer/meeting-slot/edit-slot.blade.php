              ...
              <div class="app-time">
                <div id="appended-monday">
                  <div class="form-check form-switch mb-2" style="float: right;">
                    ...
                    <input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault" {{$slotData->monday_slot ? 'checked' : ''}}  onchange="availableStatus('Monday')">
                  </div>
                  @forelse($data['monSlot'] as $k => $slot)
                    <div class="app-check col-md-6" id="monday_div_{{$k}}" style="margin-bottom: 2%;">
                      ...
                      @else 
                        <button type="button" class="btn btn-danger" style="margin-left: 2%;height: fit-content;" onclick="removeField('Monday', {{$k}})">-</button>
                      @endif
                      <input type="hidden" name="monday_dynamic" id="monday_dynamic" value="{{++$monCount}}">
                    </div>
                  @empty
            ...
            <div class="tab-pane fade" id="tuesday" role="tabpanel">
                <div class="app-time">
                    <div id="appended-tuesday">
                      <div class="form-check form-switch mb-2" style="float: right;">
                        <label for="">Available Status</label>
                        <input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault" {{$slotData->tuesday_slot ? 'checked' : ''}}  onchange="availableStatus('Tuesday')">
                      </div>
                        @forelse($data['tueSlot'] as $k => $slot)
                          <div class="app-check col-md-6" id="tuesday_div_{{$k}}" style="margin-bottom: 2%;">
                            ...
                            @else 
                              <button type="button" class="btn btn-danger" style="margin-left: 2%;height: fit-content;" onclick="removeField('Tuesday', {{$k}})">-</button>
                            @endif
                            <input type="hidden" name="tuesday_dynamic" id="tuesday_dynamic" value="{{++$tueCount}}">
                          </div>
                        @empty
              ...
              <div class="app-time">
                <div id="appended-wednesday">
                  <div class="form-check form-switch mb-2" style="float: right;">
                    ...
                    <input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault" {{$slotData->wednesday_slot ? 'checked' : ''}}  onchange="availableStatus('Wednesday')">
                  </div>
                  @forelse($data['wedSlot'] as $k => $slot)
                    <div class="app-check col-md-6" id="wednesday_div_{{$k}}" style="margin-bottom: 2%;">
                      ...
                      @else 
                        <button type="button" class="btn btn-danger" style="margin-left: 2%;height: fit-content;" onclick="removeField('Wednesday', {{$k}})">-</button>
                      @endif
                      <input type="hidden" name="wednesday_dynamic" id="wednesday_dynamic" value="{{++$wedCount}}">  
                    </div>
                  @empty
            ...
            <div class="tab-pane fade" id="thursday" role="tabpanel">
              <div class="app-time">
                <div id="appended-thursday">
                  <div class="form-check form-switch mb-2" style="float: right;">
                    <label for="">Available Status</label>
                    <input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault" {{$slotData->thursday_slot ? 'checked' : ''}}  onchange="availableStatus('Thursday')">
                  </div>
                  @forelse($data['thurSlot'] as $k => $slot)
                    <div class="app-check col-md-6" id="thursday_div_{{$k}}" style="margin-bottom: 2%;">
                      ...
                      @else 
                        <button type="button" class="btn btn-danger" style="margin-left: 2%;height: fit-content;" onclick="removeField('Thursday', {{$k}})">-</button>
                      @endif
                      <input type="hidden" name="thursday_dynamic" id="thursday_dynamic" value="{{++$thurCount}}">  
                    </div>
                  @empty
            ...
            <div class="tab-pane fade" id="friday" role="tabpanel">
              <div class="app-time">
                <div id="appended-friday">
                  <div class="form-check form-switch mb-2" style="float: right;">
                    <label for="">Available Status</label>
                    <input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault" {{$slotData->friday_slot ? 'checked' : ''}}  onchange="availableStatus('Friday')">
                  </div>
                  @forelse($data['friSlot'] as $k => $slot)
                    <div class="app-check col-md-6" id="friday_div_{{$k}}" style="margin-bottom: 2%;">
                      ...
                      @else 
                        <button type="button" class="btn btn-danger" style="margin-left: 2%;height: fit-content;" onclick="removeField('Friday', {{$k}})">-</button>
                      @endif
                      <input type="hidden" name="friday_dynamic" id="friday_dynamic" value="{{++$friCount}}">  
                    </div>
                  @empty
            ...
            <div class="tab-pane fade" id="saturday" role="tabpanel">
              <div class="app-time">
                <div id="appended-saturday">
                  <div class="form-check form-switch mb-2" style="float: right;">
                    <label for="">Available Status</label>
                    <input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault" {{$slotData->saturday_slot ? 'checked' : ''}}  onchange="availableStatus('Saturday')">
                  </div>
                  @forelse($data['satSlot'] as $k => $slot)
                    <div class="app-check col-md-6" id="saturday_div_{{$k}}" style="margin-bottom: 2%;">
                      ...
                      @else 
                        <button type="button" class="btn btn-danger" style="margin-left: 2%;height: fit-content;" onclick="removeField('Saturday', {{$k}})">-</button>
                      @endif
                      <input type="hidden" name="saturday_dynamic" id="saturday_dynamic" value="{{++$satCount}}">  
                    </div>
                  @empty
            ...
            <div class="tab-pane fade" id="sunday" role="tabpanel">
              <div class="app-time">
                <div id="appended-sunday">
                  <div class="form-check form-switch mb-2" style="float: right;">
                    <label for="">Available Status</label>
                    <input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault" {{$slotData->sunday_slot ? 'checked' : ''}}  onchange="availableStatus('Sunday')">
                  </div>
                  @forelse($data['sunSlot'] as $k => $slot)                    
                    <div class="app-check col-md-6" id="sunday_div_{{$k}}">
                      ...
                      @else
                        <button type="button" class="btn btn-danger" style="margin-left: 2%;height: fit-content;" onclick="removeField('Sunday', {{$k}})">-</button>
                      @endif
                      <input type="hidden" name="sunday_dynamic" id="sunday_dynamic" value="{{++$sunCount}}">  
                    </div>
                  @empty
