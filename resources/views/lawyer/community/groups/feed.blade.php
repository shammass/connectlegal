                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    ...
                                    <div class="create-post">
                                        <h3 style="text-align: center;"><b>{{$groupName}}</b></h3>
                                        <form action="{{route('lawyer.create.group.post', $groupId)}}" method="POST" enctype="multipart/form-data">
                                            @csrf()
                                    ...
                                    <div class="post-panel section-t-space all-group-posts">
