                    ...
                    <div class="s9-grid-item1">
                        ...
                        <div class="s9-grid-s1-group">
                            ...
                            <div class="s9-grid-s1-button">
                                <a href="{{route('lawyer.register-page')}}" style="text-decoration:none;" class="registernow white">Register<div class="h-100 bg-green"><i class="fas fa-arrow-right"></i></div></a>
                            </div>
                        </div>
                        </div>
                    </div>
