...
<div >
    ...
    <div class="heading" style="width:50%;">
        <h4 style="font-size: 24px;font-weight: 600;line-height: 7px;text-align: right;color: #3DC9A1;margin-top: 10px;">Invoice # 2311
        </h4>
...
<div class="main">
    <div class="main1">
        ...
        <div style="border: 1px solid #D9D9D9;border-radius: 15px;padding:5px 20px;height: 150px;">
            <p style="font-size: 14px;font-weight: 400;line-height: 22px;letter-spacing: 0em;text-align: left;margin: 0;">#2311<br>
              804, City Tower 2, Sheikh Zayed<br>
              Road, Dubai<br>
              sales@contactlegal.ae</p>
        </div>
    </div>
    <div class="main2">
        ...
        <div style="border: 1px solid #D9D9D9;border-radius: 15px;padding:20px;height: 120px;">
            <p style="font-size: 14px;font-weight: 400;line-height: 22px;letter-spacing: 0em;text-align: left;margin: 0;">Alejandro Ruiz Rodríguez <br> alejandro.r@connectgroup.co</p>
        </div>
    </div> 
</div>


<h3 style="font-size: 22px;font-weight: 600;line-height: 25px;letter-spacing: 0em;text-align: left;color: #191919;margin: 30px 0 15px 0;">Order # 2311</h3>
    ...
    <div class="message1"> 
        <div>
            <p style="font-weight: 400;font-size: 12px;line-height: 22px;color: #191919;margin: 0;">
               <i>“Hello this is sample comment for the lawyer and will be readed”</i> </p>
        </div>
    </div> 
</div>
