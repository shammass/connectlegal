...
@push('script')
    <script>
        ...
        function sortByCost(sortBy) {
          window.location.href = "/lawyer-services/"+lawyerId+"/" + sortBy.value;
        }
        ...
        function filterByArea(areaId) {          
          ...
          if(areaId && search) {
            window.location.href = "/lawyer-services/"+lawyerId+"/"  + sorted + "/" + search + "/" + parseInt(areaId);
          }else if(!search) {
            window.location.href = "/lawyer-services/"+lawyerId+"/"  + sorted + "/" + parseInt(areaId);
          }
        }
        ...
        $('.search-button').click(function() {
            ...
            if(areaId && search) {
                ...
                window.location.href = "/lawyer-services/"+lawyerId+"/"  + sorted + "/" + search;
            }
        });
