                    ...
                    <div class="row">
                        <div class="col-12 blog-details-text last-paragraph-no-margin margin-6-rem-bottom">
                            <ul class="list-unstyled margin-2-rem-bottom">
                                ...
                                <li class="d-inline-block align-middle margin-25px-right"><i class="feather icon-feather-calendar text-fast-blue margin-10px-right"></i><a href="blog-grid.html">{{date('M d Y', strtotime($blog->date));}}</a></li>
                                <li class="d-inline-block align-middle"><i class="feather icon-feather-user text-fast-blue margin-10px-right"></i>By <a href="blog-grid.html">{{$blog->yoast_head_json->twitter_misc->$writtenBy}}e</a></li>
                            </ul>
                            <!-- <h5 class="alt-font font-weight-500 text-extra-dark-gray margin-4-half-rem-bottom">{!! $blog->title->rendered !!}</h5> -->
                            <img src="{{$blog->yoast_head_json->og_image[0]->url}}" alt="" class="w-100 border-radius-6px margin-4-half-rem-bottom">                                                        
                        </div>                        
