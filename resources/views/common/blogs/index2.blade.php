                            ...
                            <div class="blog-post bg-white box-shadow-medium margin-30px-bottom wow animate__fadeIn">
                                <div class="d-flex flex-column flex-md-row align-items-center">
                                    <div class="blog-post-image sm-margin-25px-bottom">
                                        <a href="{{route('blogs-article-details', $v->id)}}" title=""><img src="{{$v->image}}" alt="" /></a>
                                    </div>
                                    <div class="post-details padding-4-half-rem-lr md-padding-2-half-rem-lr sm-no-padding">
                                        <a class="alt-font text-small text-fast-blue font-weight-500 text-uppercase d-inline-block margin-15px-bottom sm-margin-10px-bottom">{{date('M d Y', strtotime($v->created_at));}}</a>
                                        <a href="{{route('blogs-article-details', $v->id)}}" class="alt-font font-weight-500 text-extra-large text-extra-dark-gray d-block margin-20px-bottom sm-margin-10px-bottom">{!! $v->title !!}</a>
                                        <p class="margin-seventeen-bottom sm-margin-25px-bottom">{!! Illuminate\Support\Str::limit($v->description, 100) !!}</p>
                                        <div class="alt-font text-extra-small text-uppercase d-flex align-items-center sm-margin-10px-bottom">
                                            ...
                                            <span>
                                                <span class="d-inline-block">By <a class="text-extra-dark-gray">{{$v->written_by}}</a></span>
