                            ...
                            <div class="blog-post bg-white box-shadow-medium margin-30px-bottom wow animate__fadeIn">
                                <div class="d-flex flex-column flex-md-row align-items-center">
                                    ...
                                    <div class="post-details padding-4-half-rem-lr md-padding-2-half-rem-lr sm-no-padding">
                                        <a href="blog-masonry.html" class="alt-font text-small text-fast-blue font-weight-500 text-uppercase d-inline-block margin-15px-bottom sm-margin-10px-bottom">{{date('M d Y', strtotime($v->date));}}</a>
                                        <a href="blog-post-layout-01.html" class="alt-font font-weight-500 text-extra-large text-extra-dark-gray d-block margin-20px-bottom sm-margin-10px-bottom">{!! $v->title->rendered !!}</a>
                                        ...
                                        <div class="alt-font text-extra-small text-uppercase d-flex align-items-center sm-margin-10px-bottom">
                                            ...
                                            <span>
                                                ...
                                                <span class="d-inline-block">By <a href="blog-masonry.html" class="text-extra-dark-gray">{{$v->yoast_head_json->twitter_misc->$writtenBy}}</a></span>
